...
public class MatriculaID implements Serializable{
	...
	public void setPeriodo(String periodo) {
		this.periodo_matricula = periodo;
	}

	@Override
	public int hashCode() {
		return Objects.hash(cod_disciplina, matricula_aluno, periodo_matricula);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(cod_disciplina, other.cod_disciplina)
				&& Objects.equals(matricula_aluno, other.matricula_aluno) && Objects.equals(periodo_matricula, other.periodo_matricula);
	}
